...
user_table_create = ("""create table if not exists users(user_id int NOT NULL PRIMARY KEY , first_name varchar not null, last_name varchar,gender varchar, level varchar);\
""")

song_table_create = ("""create table if not exists songs(song_id varchar NOT NULL PRIMARY KEY, title varchar not null, artist_id varchar not null, year int, duration float not null);\
""")

artist_table_create = ("""create table if not exists artists(artist_id varchar NOT NULL PRIMARY KEY, name varchar not null, location varchar, latitude float, longitude float);\
""")
...
song_select = ("""SELECT a.song_id, a.artist_id FROM songs a 
